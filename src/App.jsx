  ...
  >
    <div
      style={{
        ...
        inset: 0,
        background:
          "linear-gradient(160deg,#f4f6f8 0%,#f5f7fb 35%,#f2f6fa 65%,#f0f4f8 100%)",
      }}
    />
    <div
      style={{
        ...
        inset: 0,
        opacity: 0.08,
        backgroundImage: `linear-gradient(${D.slate}08 1px,transparent 1px),linear-gradient(90deg,${D.slate}08 1px,transparent 1px)`,
    ...
    <div
      style={{
        ...
        width: 600,
        height: 600,
        background: `radial-gradient(circle,${D.slate}06 0%,transparent 55%)`,
        borderRadius: "50%",
        filter: "blur(80px)",
      }}
    />
    <div
      style={{
        ...
        width: 400,
        height: 400,
        background: `radial-gradient(circle,${D.copper}05 0%,transparent 55%)`,
        borderRadius: "50%",
        filter: "blur(80px)",
      }}
    />
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          >
            ...
            {tab === "markets" && <Markets lang={lang} t={t} usdt={usdt} />}
            {tab === "netpay" && <GrossToNet lang={lang} t={t} />}
            {tab === "allowance" && <AllowancePlanner lang={lang} t={t} />}
            {tab === "labor" && (
            ...
            {tab === "regulation" && <Regulation lang={lang} t={t} />}
            {tab === "countries" && (
              <Countries
                search={search}
                setSearch={setSearch}
        ...
        <footer
          style={{
            borderTop: `1px solid ${D.ln}`,
            padding: "14px 32px",
            textAlign: "center",
          }}
        >
          <span style={{ fontSize: 13, color: D.tx4 }}>
            Payband v1.1 · {t("Sample data", "範例數據")} · Ellen Chuang
          </span>
        </footer>
      </div>
    </div>
