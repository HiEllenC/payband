...
// Country multipliers
export const CM = {us:1.0,ch:1.55,sg:0.82,ae:0.75,hk:0.70,gb:0.85,kr:0.48,jp:0.50,tw:0.40,mt:0.52,ph:0.16,my:0.22};

// Base salary (USD K) by family: [IC1, IC2, IC3, IC4, IC5] and [M1..M5]
export const FB = {
  eng:{ic:[52,78,138,165,220],mgmt:[105,140,175,220,290]},
  trd:{ic:[65,100,160,240,350],mgmt:[145,195,260,350,480]},
  cmp:{ic:[48,72,128,145,190],mgmt:[95,130,165,210,275]},
  prd:{ic:[50,76,135,155,205],mgmt:[100,135,172,225,300]},
  ...
  hr:{ic:[38,55,97,118,160],mgmt:[75,100,135,180,240]},
...
export const SM = {
  ...
  qt:1.45,qr:1.10,mm:1.20,rm:0.90,ts:0.75,
